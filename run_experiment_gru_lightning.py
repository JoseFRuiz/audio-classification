...
# python run_experiment_gru_lightning.py --save_dir "gru_019" --epochs 1000 --eval_interval 10 --log_interval 10 --lr 1e-4 --batch_size 100 --use_gpu --test_size 0.1 --dropout 0.1 --loss_fn "bce"
# python run_experiment_gru_lightning.py --save_dir "gru_020" --epochs 1000 --eval_interval 10 --log_interval 10 --lr 1e-4 --batch_size 100 --use_gpu --test_size 0.1 --dropout 0.1 --loss_fn "asymmetric" --gamma_pos 0.0 --gamma_neg 4.0
# python run_experiment_gru_lightning.py --save_dir "gru_021" --epochs 1000 --eval_interval 10 --log_interval 10 --lr 1e-4 --batch_size 100 --use_gpu --test_size 0.1 --dropout 0.1 --loss_fn "contrastive" --loss_margin 0.1
